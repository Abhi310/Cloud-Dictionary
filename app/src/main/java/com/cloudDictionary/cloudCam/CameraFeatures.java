...
public final class CameraFeatures {
    ...
    public static boolean rearcamera;
    public static boolean hasFlashLight;
    public static boolean hasAutofocusOption;
    public static boolean hasSmoothZooming;
    public static boolean hasZooming;

    public static boolean shutterSound = true;
    public static boolean disableShutterSound;

    public static boolean isClickingpicture;
    ...
    public static void setDevicehardwareSupport(Camera.Parameters params, PackageManager pm) {
            ...
            if(params.getFlashMode() != null) {
                ...
                if(supportedFlashmodes == null || supportedFlashmodes.isEmpty() || supportedFlashmodes.size() == 1 && supportedFlashmodes.get(0).equals(Camera.Parameters.FLASH_MODE_OFF)) {
                    CameraFeatures.hasFlashLight = false;
                } else {
                    CameraFeatures.hasFlashLight = true;
                }
            }
            ...
            for(int i =0; i < Camera.getNumberOfCameras(); i++) {
                ...
                if(ci.facing == Camera.CameraInfo.CAMERA_FACING_BACK) {
                    CameraFeatures.rearcamera = true;
                }
                if(ci.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                    CameraFeatures.frontcamera = true;
                }
        ...
        /*
        try {
            CameraFeatures.disableShutterSound = ci.disableShutterSound;
        }catch(NoSuchFieldError ex) {
            CameraFeatures.disableShutterSound = false;
        }
        */
            ...
            if(pm.hasSystemFeature(PackageManager.FEATURE_CAMERA_AUTOFOCUS)) {
                CameraFeatures.hasAutofocusOption = true;
            }

            //check other camera Features
            if(params.isSmoothZoomSupported()) {
                CameraFeatures.hasSmoothZooming = true;
            }
            if(params.isZoomSupported()) {
                CameraFeatures.hasZooming = true;
            }
