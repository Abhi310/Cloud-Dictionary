package com.cloudDictionary.cloudCam.Utils;
...
import com.cloudDictionary.cloudCam.CameraFeatures;
...
public  class OrientationUtils {
    ...
    public static  void setCameraDisplayOrientation(int cameraid, Camera cm,Display display) {
        ...
        System.out.print("\n\n Info is here \n\n");
        System.out.print("Degrees"+ Integer.toString(degrees));
        System.out.print("Rotation"+ Integer.toString(rotation));
        System.out.print("Degrees"+ Integer.toString(degrees));
